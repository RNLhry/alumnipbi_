...
$(document).ready(function () {
    $("body").on("click", "#modalTampil", function () {
        ...
        $.get(userURL, function (alumni) {
            $("#modalShow").modal("show");
            $("#alumni-id").text(alumni.id);
            $("#alumni-name").text(alumni.nama);
            $("#alumni-email").text(alumni.email);
            // Perbarui konten modal dengan data lainnya jika diperlukan
        });
    });
});
